...
# -*- coding: utf-8 -*-
"""
Advanced GPT Assistant Integration Test
AI Model Integration tizimi uchun integratsiya testi

Bu fayl tizimning barcha asosiy funksiyalarini test qiladi
va ishlash holatini tekshiradi.
...
class AIIntegrationTestSuite:
    ...
    def test_imports(self) -> bool:
        """Import test"""
        if IMPORTS_SUCCESS:
            self.log_test("Import Test", "pass", {"message": "All imports successful"})
            return True
        else:
            self.log_test("Import Test", "fail", {"message": "Import failed"})
            return False
    
    def test_assistant_creation(self) -> bool:
        """Assistant yaratish testi"""
        try:
            # Demo API keys bilan (real API calls bo'lmaydi)
            ...
            if self.assistant is not None:
                self.log_test("Assistant Creation", "pass", {
                    "openai_client": self.assistant.openai_client is not None,
                    "gemini_model": self.assistant.gemini_model is not None,
                    "trading_optimizer": hasattr(self.assistant, 'trading_optimizer')
                })
                return True
            else:
                self.log_test("Assistant Creation", "fail", {"message": "Assistant is None"})
                return False
                
        except Exception as e:
            self.log_test("Assistant Creation", "error", {"error": str(e)})
            return False
        ...
        try:
            ...
            for strategy in strategies:
                try:
                    ...
                    if selected_model not in self.assistant.MODEL_CONFIGS:
            ...
            self.log_test("Model Selection", "error", {"error": str(e)})
            return False
    ...
    def test_cache_functionality(self) -> bool:
        ...
        try:
            ...
            if cached_response is None:
                cache_get_works = True
            else:
                cache_get_works = False
            
            # Test set
            from advanced_gpt_assistant import ModelResponse
    ...
    def test_rate_limiter(self) -> bool:
        ...
        try:
            if not self.assistant:
                self.log_test("Rate Limiter", "skip", {"message": "Assistant not created"})
                return False
            
            from advanced_gpt_assistant import RateLimiter
    ...
    def test_error_handling(self) -> bool:
        ...
        try:
            ...
            try:
                # This should not raise an exception but use default strategy
                selected_model = self.assistant._select_best_model(
            ...
            try:
                ...
                cache_error_handling = True
            except:
                cache_error_handling = False
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        print("🚀 Advanced GPT Assistant Integration Test Suite")
        print("=" * 60)
        ...
        # Overall status
        if success_rate >= 80:
            print("🎉 INTEGRATSIYA TESTI MUVAFFAQIYATLI!")
        elif success_rate >= 60:
            print("⚠️ INTEGRATSIYA TESTI Qisman muvaffaqiyatli")
        else:
            print("💥 INTEGRATSIYA TESTI MUVAFFAQIYATSIZ")
    ...
    def save_test_results(self):
        ...
        try:
            results = {
                "test_suite": "Advanced GPT Assistant Integration",
                "version": "2.0.0",
                "start_time": self.start_time.isoformat(),
            ...
            with open("ai_assistant_integration_test_results.json", "w", encoding="utf-8") as f:
                json.dump(results, f, indent=2, ensure_ascii=False)
            
            print()
            print("💾 Test natijalari 'ai_assistant_integration_test_results.json' ga saqlandi")
