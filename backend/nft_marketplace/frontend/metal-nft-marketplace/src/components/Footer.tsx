...
export const Footer: React.FC = () => {
  ...
  const footerLinks = {
    platform: [
      { name: 'Bozor', href: '/marketplace' },
      { name: 'Portfolio', href: '/portfolio' },
      { name: 'Listing yaratish', href: '/create-listing' },
      { name: 'Sertifikatlar', href: '/certification' }
    ],
    resources: [
    ...
    legal: [
      ...
      { name: 'Risklar haqida', href: '/risks' },
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Qimmatbop metallarga asoslangan autentik NFT tokenlari bilan 
              global bozorda savdo qiling.
            </p>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-slate-400 text-sm">
            © {currentYear} MetalNFT. Barcha huquqlar himoyalangan.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-slate-400 text-sm">Built with</span>
            <div className="flex items-center space-x-2">
              <span className="text-red-400">❤️</span>
              <span className="text-slate-400 text-sm">by MetalNFT Team</span>
            </div>
          </div>
        </div>
      </div>
