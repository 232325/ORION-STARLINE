-- Migration: final_modules_database_schema
-- Created at: 1762217496

-- Final Modules Database Schema
...
('Trading Signals', 'Professional trading signals and alerts', '📊', 1),
('AI Strategies', 'AI-generated trading strategies', '🤖', 2),
('Risk Management', 'Advanced risk management tools', '🛡️', 3),
('Analytics', 'Market analysis and insights', '📈', 4),
('Education', 'Trading courses and tutorials', '📚', 5)
ON CONFLICT (name) DO NOTHING;

INSERT INTO premium_products (name, description, price, category, features, duration_days) VALUES
('Pro Trading Signals', 'High-accuracy trading signals with 90%+ success rate', 299.99, 'Trading Signals', '{"signals_per_month": 50, "accuracy_rate": 90, "support": "24/7"}', 30),
('AI Strategy Pack', 'Collection of AI-generated trading strategies', 199.99, 'AI Strategies', '{"strategies_count": 10, "backtest_results": "available", "updates": "monthly"}', 30),
('Risk Manager Pro', 'Advanced risk management and portfolio optimization', 149.99, 'Risk Management', '{"portfolio_analysis": true, "risk_alerts": true, "stop_loss_management": true}', 30),
('Market Analytics Suite', 'Comprehensive market analysis and predictions', 399.99, 'Analytics', '{"predictions": "AI-powered", "sentiment_analysis": true, "technical_indicators": 50}', 30)
ON CONFLICT (name) DO NOTHING;;